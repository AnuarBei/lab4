...
class CharactersVC: UITableViewController {
    private var characters: [Character] =
        [
            Character(name: "Vkontakte", address:  "https://www.vk.com"),
            Character(name: "Instagram", address:
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "showDetail"{
            ...
            if let destination = segue.destination as? infoVC{
                            destination.myUrl = characters[tableView.indexPathForSelectedRow!.row].address
                        }
